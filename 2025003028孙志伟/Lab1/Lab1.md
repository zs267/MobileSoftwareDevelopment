...
fun main() {
    ...
    println("Student 2025003028 says hello")
}
```
...
fun main() {
    ...
    println("Hello, my name is sunzhiwei")
}
```
...
```kotlin
fun main() {
    println("ID: 2025003028")
    println("Name: sunzhiwei")
...
```kotlin
fun main() {
    val name: String="sunzhiwei"
    val studentID: String="2025003028"
...
fun main() {
    ...
    println(sunzhiweiGreeting(age = 8))       
    println(sunzhiweiGreeting("sunzhiwei", 2))   
}
fun sunzhiweiGreeting(name: String = "2025003028", age: Int): String {
...
```kotlin
fun main() {
    printSunzhiweiWeather("Ankara", 27, 31, 82)
    printSunzhiweiWeather("Tokyo", 32, 36, 10)
    printSunzhiweiWeather("Cape Town", 59, 64, 2)
    printSunzhiweiWeather("Guatemala City", 50, 55, 7)
}
fun printSunzhiweiWeather(
    city: String, 
    lowTemp: Int, 
    highTemp: Int, 
    rainChance: Int
